...
public class AbkJabatanAdapter extends RecyclerView.Adapter<AbkJabatanAdapter.ViewHolder> {
    DatabaseReference reference = FirebaseDatabase.getInstance().getReference("Jabatan");
    private Context mContext;
    private List<Jabatan> mJabatan;

    public AbkJabatanAdapter(Context mContext, List<Jabatan> mJabatan){
    ...
    @NonNull
    @Override
    public AbkJabatanAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.tambah_uraian.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(mContext, TampilSemuaAbkUraian.class);
                intent.putExtra("uid_jabatan", jabatan.getId_jabatan());
                mContext.startActivity(intent);
            }
        });
