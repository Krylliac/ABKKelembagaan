...
import com.example.abkkelembagaan.ABK.TampilSemuaAbkUraian;
import com.example.abkkelembagaan.ExportActivity;
...
public class EksporJabatanAdapter extends RecyclerView.Adapter<EksporJabatanAdapter.ViewHolder> {
    DatabaseReference reference = FirebaseDatabase.getInstance().getReference("Jabatan");
    private Context mContext;
    private List<Jabatan> mJabatan;

    public EksporJabatanAdapter(Context mContext, List<Jabatan> mJabatan){
    ...
    @NonNull
    @Override
    public EksporJabatanAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.list_export, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (AppCompatDelegate.getDefaultNightMode() != AppCompatDelegate.MODE_NIGHT_YES) {
            ...
            holder.export.setColorFilter(Color.parseColor("#0c0c0c"));
        }else {
            ...
            holder.export.setColorFilter(Color.parseColor("#ebebeb"));
        }
