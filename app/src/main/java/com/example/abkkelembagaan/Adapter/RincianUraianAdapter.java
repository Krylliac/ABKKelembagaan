...
public class RincianUraianAdapter extends RecyclerView.Adapter<RincianUraianAdapter.ViewHolder> {
    private Context mContext;
    private List<UraianTugas> mTugas;
    DatabaseReference reference = FirebaseDatabase.getInstance().getReference("Jabatan");

    public RincianUraianAdapter(Context mContext, List<UraianTugas> mTugas){
        this.mTugas = mTugas;
    ...
    @NonNull
    @Override
    public RincianUraianAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
