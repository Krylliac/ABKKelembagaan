...
public class UraianJabatanAdapter extends RecyclerView.Adapter<UraianJabatanAdapter.ViewHolder> {
    DatabaseReference reference = FirebaseDatabase.getInstance().getReference("Jabatan");
    private Context mContext;
    private List<Jabatan> mJabatan;

    public UraianJabatanAdapter(Context mContext, List<Jabatan> mJabatan){
    ...
    @NonNull
    @Override
    public UraianJabatanAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.list_uraian_jabatan, parent, false);
